...
function format(source, options = {}) {
	...
	for (let i = 0; i < lines.length; i++) {
		...
		// left this one untouched: it harvested `doc: '[DT-1](slices/DT-1_....md)'` into
		// `doc: '[DT-1][dt-1]'` plus a definition appended to the BODY. The field still read fine, and
