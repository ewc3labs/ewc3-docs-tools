...
function format(source, options = {}) {
	...
	for (let i = 0; i < lines.length; i++) {
		...
		// left this one untouched: it harvested `doc: '[DOCS-1](slices/DOCS-1_....md)'` into
		// `doc: '[DOCS-1][docs-1]'` plus a definition appended to the BODY. The field still read fine, and
