 ...
 * `[DT-51][dt-51]` is correct as DATA - the definition lives in the REGISTER, where that cell
 * renders - and `links` reported it as an undefined reference in the document that merely carries
 * it. Same root as `DT-52`: only the two components that CONSUME slice documents knew the format
