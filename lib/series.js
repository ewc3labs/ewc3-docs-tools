...
function readSeriesText(source, file = '') {
	...
	// DOCS-082: the line below matched `Prefix` only, for as long as this comment has said otherwise. A register
	...
	// (`DevTools`) declares nothing, as it should.
	const headerAt = text.search(/^\|\s*(?:Prefix|Series)\s*\|/im);
	if (headerAt !== -1) {
