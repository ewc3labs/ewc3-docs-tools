...
const DEFAULT_ROADMAPS = [
	...
	// `series` reported success over zero files - the same silent-coverage shape as DOCS-7.
 ...
 *
 * The toolkit already learned this once - `values` ignores markers inside fences (DOCS-10), because
...
function withoutFences(text) {
	...
	return text.split('\n').map((line) => {
		...
		//
		// This is not hypothetical and it is not subtle: this repository's own roadmap row for DOCS-9
