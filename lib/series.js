 ...
 *
 * The toolkit already learned this once - `values` ignores markers inside fences (DT-10), because
...
function withoutFences(text) {
	...
	return text.split('\n').map((line) => {
		...
		//
		// This is not hypothetical and it is not subtle: this repository's own roadmap row for DT-9
