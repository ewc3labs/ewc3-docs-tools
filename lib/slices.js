...
function inventorySlices(entries) {
	// `written` is the id as it appears, for DISPLAY: the inventory printed DW-12 where the filename, the row
	// and the frontmatter all said DW-012, so a grep for DW-012 missed the line (PMO census). `id` stays
