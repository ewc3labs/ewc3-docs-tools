...
est: S
doc: '[DOCS-46](slices/DOCS-46_A_slice_document_must_CARRY_the_reference_definitions_it_u.md)'
status: ""
source: EWC3_Docs_Tools_Roadmap.md
---

# DOCS-46 — A slice document must CARRY the reference definitions it uses
