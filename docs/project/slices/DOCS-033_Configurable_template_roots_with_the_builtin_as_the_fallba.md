...
# DOCS-033 — Configurable template roots, with the builtin as the fallback
...
rather than sniffed — which is what separates it from the reverted `DOCS-025`/`DOCS-028`
