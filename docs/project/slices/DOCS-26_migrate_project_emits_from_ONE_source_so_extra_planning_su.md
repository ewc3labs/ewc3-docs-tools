...
est: M
doc: '[DOCS-26](slices/DOCS-26_migrate_project_emits_from_ONE_source_so_extra_planning_su.md)'
status: ""
source: EWC3_Docs_Tools_Roadmap.md
---

# DOCS-26 — `migrate-project` emits from ONE source, so extra planning surfaces are dropped
...
disagree" and either side can be the liar; here it was the scanner, via `DOCS-33`. Kept as a row
