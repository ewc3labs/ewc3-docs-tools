...
est: S
doc: '[DOCS-54](slices/DOCS-54_Migration_never_regenerates_an_authored_slice.md)'
...
# DOCS-54 — `migrate-project` must never regenerate a slice document a human already authored
...
frozen. `DOCS-51`, `DOCS-52` and `DOCS-53` keep their authored prose, and their register rows point
at the real filenames. 155 passing, 0 failing.
