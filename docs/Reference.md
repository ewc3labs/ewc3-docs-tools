...
versus a pipe, and a reference link versus the inline link it resolves to are all the same cell.
Nothing else is folded. A no-break space, a variation selector or a definition pointing somewhere
